...
|     2.   Garantir qualidade do código             	|     Quantos   bugs são reportados por sprint?                  	|     Densidade de bugs                        	|     Nº de   bugs / Nº de tarefas concluídas                       	|     %           	|     ≤ 20%                	|     Revisar   testes de unidade (T01) e refatoração (DT03)             	|
